...
return [
    ...
    'allowed_origins' => array_values(array_filter(array_map('trim', explode(',', env('CORS_ALLOWED_ORIGINS', 'https://acelogstores.online,http://acelogstores.online,https://host.hotelbiza.online,http://host.hotelbiza.online,http://127.0.0.1:8080,http://localhost:8080,http://localhost:5173,http://127.0.0.1:5173')))) ?: ['https://acelogstores.online', 'http://127.0.0.1:8080', 'http://localhost:8080']),
